 ...
 */
        ...
        public class Printer
        {
            ...
            public static void main(String[] args) throws Exception
            {
                ...
                //ball and socket
                if (dependent.size() > 0 && implementation.size() > 0)
                {
                    String ball_1 = "";
                    String ball_2 = "";
                    String user = "";
                    ...
                    {
                        int arrow = dependent.get(i).indexOf(">");
                        int comma = dependent.get(i).indexOf(":");
                        ball_1 = dependent.get(i).substring(arrow + 1, comma - 1);
                        socket = dependent.get(i).substring(0,dependent.get(i).indexOf("."));
                        d = i;
                        //System.out.println(socket);
                    }
                    for (int i =0; (4*i+3) < implementation.size();i++)
                    {
                        ball_2 = implementation.get(4*i+2);
                        user = implementation.get(4*i);
                        m = i;
                        //System.out.println(ball2);
                    }
                    if (ball_1.equals(ball_2) && d >= 0 && m >= 0)
                    {
                        dependent.remove(d);
                        implementation.remove(4*m + 3);
                        implementation.remove(4*m + 2);
                        implementation.remove(4*m + 1);
                        implementation.remove(4*m);
                        source += user + RelationSymbol.ballnsocket.toString() + socket + " :  I " + ball_1 + "\n";
                        //System.out.println(user + RelationSymbol.ballnsocket.toString() + socket + " :  I " + ball_1 + "\n");
                    }
                }
                ...
                System.out.println("UML ball&socket diagram is generated: " + folderpath + "/" + umlname + ".png");
            }
